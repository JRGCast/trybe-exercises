...
// Modifique o valor total da compra para R$ 50,00.
  const orderModifier = (order) => {
    ...
    console.log(`Olá ${order.name}, o total do seu pedido de ${Object.keys(order.order.pizza)} + ${Object.values(order.order.drinks.coke)[0]} deu R\$${order.payment.total},00, mas demos um descontaço e ficou em R\$${order.payment.newTotal},00!`)
